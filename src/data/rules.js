...
export const RULES = [
  ...
  { ic: '🧑‍💻', bg: 'var(--blue-bg)', on: true, name: 'Auto-assign by application', desc: 'On create — requests are assigned to the right owner automatically: AWS → David, Hardware → Arun, Network / VPN → Tyler Austin.', log: 'Applies to AWS, Hardware, Network / VPN' },
