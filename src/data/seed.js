...
const ROWS = [
  ...
  [106, 'Datadog', 'Elevated Datadog access for on-call', 'Pending Approval', 'High', 6, { manager: 'line-manager@fuseenergy.com' }],
  ...
  [127, 'Account Onboarding / Offboarding', 'Onboard new trading analyst', 'Done', 'High', 7],
